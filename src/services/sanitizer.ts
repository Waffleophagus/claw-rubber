...
export function extractContent(
  ...
  const raw = mode === "markdown" ? sanitizeToMarkdown(input) : sanitizeToText(input, Number.MAX_SAFE_INTEGER);
...
function applyMaxChars(content: string, maxChars?: number): { content: string; truncated: boolean } {
